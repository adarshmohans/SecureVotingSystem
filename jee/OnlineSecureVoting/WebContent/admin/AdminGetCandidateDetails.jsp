...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 try{
	 ...
	 String str="";
	 ResultSet res=stmt.executeQuery("select * from tbl_nomination where status='0'");
	 ...
	 while(res.next()){
		 ...
		 String nomination_id=res.getString("tbl_nomination_id");
		 str=ward+" "+wardno;
		 ...
		 jo.put("nomination_id", nomination_id);
		 ja.add(jo);
	 }
	 out.println(ja);
